# --------- 
"""
vocab 7000 60 epochs model 128 inner 128 heads 5 layers 3 dropout 0.3 key 128 lr 0.01
"""
#-----------
...
def split(eng_sen, fren_sen_in, fren_sen_out, total_size, train_size):
	...
	return eng_sen_train, eng_sen_val, fren_sen_train_in, fren_sen_val_in, fren_sen_train_out, fren_sen_val_out#-------- COPYING FILE utils.py--------------
